...
@[simp]
lemma Game_World.world_after_fst_fst_win_states {α β : Type u} (g : Game_World α β)
  (fst_act : β) : (g.world_after_fst fst_act).fst_win_states = g.fst_win_states :=
  by rfl


@[simp]
lemma Game_World.world_after_fst_snd_win_states {α β : Type u} (g : Game_World α β)
  (fst_act : β) : (g.world_after_fst fst_act).snd_win_states = g.snd_win_states :=
  by rfl

@[simp]
lemma Game_World.world_after_fst_fst_transition {α β : Type u} (g : Game_World α β)
  (fst_act : β) : (g.world_after_fst fst_act).fst_transition = g.fst_transition :=
  by rfl

@[simp]
lemma Game_World.world_after_fst_snd_transition {α β : Type u} (g : Game_World α β)
...
structure Game_World.coherent_end_aux
  (g : Game_World α β) (f_strat s_strat : Strategy α β) (t : ℕ) : Prop where
...
lemma Game_World.playable_has_strat (g : Game_World α β)
  (hg : g.playable) :
  ...
  · intro t _
    ...
    (fun ini hist => Classical.choose (_ : ∃ act, Game_World.snd_legal g ini hist act)) t)
...
structure zGame_World (α β : Type _) extends Game_World α β where
  f_legal_careless : careless toGame_World.fst_legal toGame_World.snd_legal toGame_World.init_game_state toGame_World.fst_legal toGame_World.fst_transition
  s_legal_careless : careless toGame_World.fst_legal toGame_World.snd_legal toGame_World.init_game_state toGame_World.snd_legal toGame_World.fst_transition
  f_transition_careless : careless toGame_World.fst_legal toGame_World.snd_legal toGame_World.init_game_state toGame_World.fst_transition toGame_World.fst_transition
  s_transition_careless : careless toGame_World.fst_legal toGame_World.snd_legal toGame_World.init_game_state toGame_World.snd_transition toGame_World.fst_transition
  coherent : toGame_World.coherent_end
  playable : toGame_World.playable
  sym_trans : toGame_World.fst_transition = toGame_World.snd_transition
  sym_legal : toGame_World.fst_legal = toGame_World.snd_legal
  sym_win : toGame_World.fst_win_states = toGame_World.snd_win_states


structure zGame (α β : Type _) extends zGame_World α β where
...
def fst_strat_deconditioned (s_strat : Strategy α β) (f_act : β) (g : Game_World α β) : Strategy α β :=
  (fun _ hist => if hist = [] then f_act else s_strat (g.world_after_fst f_act).init_game_state (hist.dropLast))

def snd_strat_deconditioned (f_strat : Strategy α β) (f_act : β) (g : Game_World α β) : Strategy α β :=
  (fun _ hist => f_strat (g.world_after_fst f_act).init_game_state (hist.dropLast))

lemma Game_World.History_of_deconditioned
  (g: Game_World α β)
  (fst_act: β)
...
def Game_World.transition_blind_fst (g : Game_World α β) : Prop :=
...
def Game_World.transition_blind_snd (g : Game_World α β) : Prop :=
  ∀ f_strat s_strat: Strategy α β, ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
  let fst_strat := fst_strat_deconditioned s_strat fst_act g
  let snd_strat := snd_strat_deconditioned f_strat fst_act g
...
def Game_World.transition_blind (g : Game_World α β) : Prop :=
 g.transition_blind_fst ∧ g.transition_blind_snd


def Game_World.strong_transition_blind_fst (g : Game_World α β) : Prop :=
...
def Game_World.strong_transition_blind_snd (g : Game_World α β) : Prop :=
  ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
...
def Game_World.strong_transition_blind (g : Game_World α β) : Prop :=
 g.strong_transition_blind_fst ∧ g.strong_transition_blind_snd

lemma Game_World.strong_transition_blind_toWeak (g : Game_World α β) :
  ...
  · intro f_strat s_strat f_act f_act_leg fst_strat snd_strat t act
    rw [Game_World.History_of_deconditioned]
    apply f_strong
    exact f_act_leg
  · intro f_strat s_strat f_act f_act_leg fst_strat snd_strat t act
    rw [Game_World.History_of_deconditioned]
...
def Game_World.world_after_preHist {α β : Type u} (g : Game_World α β)
  (prehist : List β) : Game_World α β := -- act not required to be legal
  match prehist with
  | [] => g
...
def Game_World.hyper_transition_blind_fst (g : Game_World α β) : Prop :=
...
def Game_World.hyper_transition_blind_snd (g : Game_World α β) : Prop :=
  ∀ prehist : List β, Hist_legal g.fst_legal g.snd_legal g.init_game_state prehist →
...
def Game_World.hyper_transition_blind (g : Game_World α β) : Prop :=
 g.hyper_transition_blind_fst ∧ g.hyper_transition_blind_snd


lemma Game_World.hyper_transition_blind_transition_eq (g : Game_World α β) :
  ...
  dsimp [Game_World.world_after_preHist] at this
  simp_rw [List.append_nil] at this
  apply funext₂
  exact this


lemma Game_World.hyper_transition_blind_toStrong (g : Game_World α β) :
...
@[simp]
lemma Game_World.world_after_preHist_singleton {α β : Type u} (g : Game_World α β)
  (act : β) : g.world_after_preHist [act] = g.world_after_fst act :=
  by
  dsimp [Game_World.world_after_fst, Game_World.world_after_preHist]


lemma zGame_World.is_hyper_transition_blind (g : zGame_World α β) :
  g.toGame_World.hyper_transition_blind :=
  by
  constructor
  · intro prehist preh_leg hist act
    ...
    match prehist with
    | [] =>
        dsimp [Game_World.world_after_preHist]
...
lemma Game_World.State_of_deconditioned
  (g: Game_World α β)
  ...
  · dsimp [state_on_turn]
    ...
    · rw [Turn_not_fst_iff_snd, Turn_snd_fst_step] at q
      ...
      dsimp at this
      specialize this t (s_strat (world_after_fst g fst_act).init_game_state (History_on_turn (Game_World.fst_transition g g.init_game_state [] fst_act) f_strat s_strat t))
      rw [← Game_World.world_after_fst_init] at this
      rw [← Game_World.world_after_fst_init]
      rw [← this]


lemma zGame_World.State_of_deconditioned
  (g: zGame_World α β)
  (fst_act: β)
  (fst_act_legal: g.fst_legal g.init_game_state [] fst_act)
  (f_strat s_strat : Strategy α β)
  (turn : ℕ):
  let fst_strat := fst_strat_deconditioned s_strat fst_act g.toGame_World
  let snd_strat := snd_strat_deconditioned f_strat fst_act g.toGame_World
  g.state_on_turn fst_strat snd_strat (turn + 1) =
  (g.world_after_fst fst_act).state_on_turn f_strat s_strat turn :=
  by
  apply Game_World.State_of_deconditioned
  · apply Game_World.strong_transition_blind_toWeak
    apply Game_World.hyper_transition_blind_toStrong
    apply zGame_World.is_hyper_transition_blind
  · exact fst_act_legal



def zGame_World.world_after_fst {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) : zGame_World α β :=
  {(g.toGame_World.world_after_fst fst_act) with
      ...
      coherent := by
                  ...
                  · intro fws
                    ...
                    dsimp [Game_World.world_after_fst] at this
                    rw [← this] at *
                    clear this
                    have := (g.coherent (fst_strat_deconditioned s_strat fst_act g.toGame_World) (snd_strat_deconditioned f_strat fst_act g.toGame_World) (t+1)).f
                    exact this fws
                  · intro fws
                    dsimp at *
                    have := g.State_of_deconditioned fst_act fst_act_legal f_strat s_strat
                    ...
                    rw [← this] at *
                    clear this
                    have := (g.coherent (fst_strat_deconditioned s_strat fst_act g.toGame_World) (snd_strat_deconditioned f_strat fst_act g.toGame_World) (t+1)).s
                    exact this fws
...
lemma zGame_World.world_after_fst_init (g : zGame_World α β)
...
@[simp]
lemma zGame_World.world_after_fst_fst_legal {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
  (g.world_after_fst fst_act fst_act_legal).fst_legal = g.fst_legal :=
  by rfl

@[simp]
lemma zGame_World.world_after_fst_snd_legal {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
  (g.world_after_fst fst_act fst_act_legal).snd_legal = g.snd_legal :=
  by rfl

@[simp]
lemma zGame_World.world_after_fst_fst_win_states {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
...
@[simp]
lemma zGame_World.world_after_fst_snd_win_states {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
  (g.world_after_fst fst_act fst_act_legal).snd_win_states = g.snd_win_states :=
  by rfl

@[simp]
lemma zGame_World.world_after_fst_fst_transition {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
  (g.world_after_fst fst_act fst_act_legal).fst_transition = g.fst_transition :=
  by rfl

@[simp]
lemma zGame_World.world_after_fst_snd_transition {α β : Type u} (g : zGame_World α β)
  (fst_act : β) (fst_act_legal: g.fst_legal g.init_game_state [] fst_act) :
...
lemma Game_World.world_after_fst_History_strong_blind (g : Game_World α β)
  ...
  · unfold History_on_turn
    ...
    · rw [if_pos q]
      rw [List.cons_append, ih]
      specialize hs (f_strat g.init_game_state []) (by apply f_leg 0 (by decide)) (History_on_turn (Game_World.fst_transition g g.init_game_state [] (f_strat g.init_game_state [])) s_strat f_strat t)
      rw [← Game_World.world_after_fst_init] at hs
      rw [hs, ih]
      rw [if_neg (show ¬ Turn_fst (Nat.succ t + 1) from (by rw [← Turn_fst_not_step]; exact q))]
    · rw [if_neg q]
      rw [List.cons_append, ih]
      specialize hf (f_strat g.init_game_state []) (by apply f_leg 0 (by decide)) (History_on_turn (Game_World.fst_transition g g.init_game_state [] (f_strat g.init_game_state [])) s_strat f_strat t)
...
def Game_World.legal_blind_fst (g : Game_World α β) : Prop :=
  ∀ f_strat s_strat: Strategy α β, ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
  let fst_strat := fst_strat_deconditioned s_strat fst_act g
  let snd_strat := snd_strat_deconditioned f_strat fst_act g
...
def Game_World.legal_blind_snd (g : Game_World α β) : Prop :=
  ∀ f_strat s_strat: Strategy α β, ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
  let fst_strat := fst_strat_deconditioned s_strat fst_act g
  let snd_strat := snd_strat_deconditioned f_strat fst_act g
...
def Game_World.legal_blind (g : Game_World α β) : Prop :=
 g.legal_blind_fst ∧ g.legal_blind_snd


def Game_World.strong_legal_blind_fst (g : Game_World α β) : Prop :=
  ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
...
def Game_World.strong_legal_blind_snd (g : Game_World α β) : Prop :=
  ∀ fst_act : β, g.fst_legal g.init_game_state [] fst_act →
...
def Game_World.strong_legal_blind (g : Game_World α β) : Prop :=
 g.strong_legal_blind_fst ∧ g.strong_legal_blind_snd

lemma Game_World.strong_legal_blind_toWeak (g : Game_World α β) :
...
def Game_World.hyper_legal_blind_fst (g : Game_World α β) : Prop :=
  ∀ prehist : List β, Hist_legal g.fst_legal g.snd_legal g.init_game_state prehist →
...
def Game_World.hyper_legal_blind_snd (g : Game_World α β) : Prop :=
  ∀ prehist : List β, Hist_legal g.fst_legal g.snd_legal g.init_game_state prehist →
...
def Game_World.hyper_legal_blind (g : Game_World α β) : Prop :=
 g.hyper_legal_blind_fst ∧ g.hyper_legal_blind_snd


lemma Game_World.hyper_legal_blind_legal_eq (g : Game_World α β) :
...
lemma Game_World.hyper_legal_blind_toStrong (g : Game_World α β) :
...
lemma zGame_World.is_hyper_legal_blind (g : zGame_World α β) :
  g.toGame_World.hyper_legal_blind :=
  by
  constructor
  · intro prehist preh_leg hist act
...
lemma Game_World.fst_legal_deconditioned
  (g: Game_World α β)
  (fst_act: β)
  (fst_act_legal: g.fst_legal g.init_game_state [] fst_act)
  (f_strat s_strat : Strategy α β)
  ...
  · dsimp [History_on_turn, fst_strat_deconditioned]
    rw [if_pos (by rfl)]
    exact fst_act_legal
  · rw [← b, Game_World.History_of_deconditioned]
    · dsimp [History_on_turn, fst_strat_deconditioned]
...
lemma Game_World.snd_legal_deconditioned
  (g: Game_World α β)
  (fst_act: β)
  (fst_act_legal: g.fst_legal g.init_game_state [] fst_act)
  (f_strat s_strat : Strategy α β)
...
def zGame.history_on_turn {α β : Type u} (g : zGame α β) : ℕ → List β :=
  History_on_turn g.init_game_state g.fst_strat g.snd_strat


def zGame.state_on_turn {α β : Type u} (g : zGame α β) : ℕ → α
| 0 => g.init_game_state
...
inductive zGame_World.has_WL (g : zGame_World α β) : Prop where
| wf : g.is_fst_win → g.has_WL
| ws : g.is_snd_win → g.has_WL


lemma zGame_World.has_WL_init_end
  (g : zGame_World α β)
  (P : Prop)
  (hp : P)
  (h : (P ∧ (¬ g.snd_win_states g.init_game_state)) → g.has_WL) :
...
def zGame_World.snd_strat_conditioned (f_strat : Strategy α β) (f_act : β) (g : zGame_World α β) : Strategy α β :=
  fun _ hist => f_strat g.init_game_state (hist ++ [f_act])

open Classical

noncomputable
def zGame_World.fst_strat_conditioned [Inhabited β] (g : zGame_World α β)
...
lemma zGame_World.history_on_turn_conditioned
  ...
  · dsimp [Game_World.history_on_turn, History_on_turn]
    ...
    · rw [if_pos q]
      ...
      dsimp [zGame_World.snd_strat_conditioned]
      unfold Game_World.history_on_turn at ih
      rw [← ih]
      dsimp [History_on_turn]
      rw [if_neg q]
    · rw [if_neg q]
      ...
      dsimp [zGame_World.fst_strat_conditioned]
...
lemma zGame_World.state_on_turn_conditioned
  [Inhabited β] (g : zGame_World α β) (fst_s: Strategy α β)
  (f_strat : (h : List β) → (hne : h ≠ []) → (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → Strategy α β)
  (h_f_strat : ∀ h H: List β, (hne : h ≠ []) → (Hne : H ≠ []) →
      (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → (Hl : g.fst_legal g.init_game_state [] (H.getLast Hne)) →
  ...
  · dsimp [Game_World.state_on_turn]
    rw [if_pos (by decide)]
    dsimp [Game_World.history_on_turn, History_on_turn, zGame_World.world_after_fst_init]
  · dsimp [Game_World.state_on_turn]
    ...
    · rw [if_pos q]
      ...
      specialize this g.init_game_state ((Game_World.history_on_turn (world_after_fst g (fst_s g.init_game_state []) f_act_leg).toGame_World
    ...
    · rw [if_neg q]
      ...
      dsimp
      rw [List.append_nil]
      have := h_f_strat ((Game_World.history_on_turn (world_after_fst g (fst_s g.init_game_state []) f_act_leg).toGame_World
            (f_strat [fst_s g.init_game_state []] ((by apply List.cons_ne_nil) : [fst_s g.init_game_state []] ≠ []) f_act_leg)
...
lemma zGame_World.conditioned_legal_fst
  [Inhabited β] (g : zGame_World α β) (fst_s: Strategy α β)
  (f_strat : (h : List β) → (hne : h ≠ []) → (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → Strategy α β)
  (h_f_strat : ∀ h H: List β, (hne : h ≠ []) → (Hne : H ≠ []) →
      (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → (Hl : g.fst_legal g.init_game_state [] (H.getLast Hne)) →
  ...
  · intro leg t ts
    ...
    unfold Game_World.history_on_turn at hh
    rw [hh] at leg
    rw [hc] at leg
...
lemma zGame_World.conditioned_legal_snd
  [Inhabited β] (g : zGame_World α β) (fst_s: Strategy α β)
  (f_strat : (h : List β) → (hne : h ≠ []) → (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → Strategy α β)
  (h_f_strat : ∀ h H: List β, (hne : h ≠ []) → (Hne : H ≠ []) →
      (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → (Hl : g.fst_legal g.init_game_state [] (H.getLast Hne)) →
  ...
  · intro leg t tf
    ...
    · dsimp [snd_strat_conditioned]
      ...
      have := h_f_strat ((Game_World.history_on_turn (world_after_fst g (fst_s g.init_game_state []) f_act_leg).toGame_World
              ...
              (by apply f_act_leg)
              (by rw [List.getLast_append] ; dsimp)
      unfold Game_World.history_on_turn at this
      rw [this] at leg
  ...
  · intro leg t ts
    ...
    · have hh := g.history_on_turn_conditioned fst_s f_strat h_f_strat f_act_leg t
      ...
      rw [hc]
      · rw [← g.sym_legal]
        rw [zGame_World.world_after_fst_fst_legal] at leg
        convert leg using 1
        dsimp [fst_strat_conditioned]
        rw [dif_neg (by apply List.append_ne_nil_of_ne_nil_right ; apply List.cons_ne_nil)]
        rw [dif_pos (by rw [List.getLast_append] ; apply f_act_leg)]
...
lemma zGame_World.conditioned_state_on_turn_neutral
  [Inhabited β] (g : zGame_World α β) (fst_s: Strategy α β)
  (f_strat : (h : List β) → (hne : h ≠ []) → (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → Strategy α β)
  (h_f_strat : ∀ h H: List β, (hne : h ≠ []) → (Hne : H ≠ []) →
      (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → (Hl : g.fst_legal g.init_game_state [] (H.getLast Hne)) →
...
lemma History_on_turn_eq_strats_snd
  (g : zGame_World α β) (f_strat sSa aSb: Strategy α β)
...
lemma Strategy_legal_fst_eq_strats_snd
  (g : zGame_World α β) (f_strat sSa sSb: Strategy α β)
  (h : ∀ t, Turn_snd (t+1) → sSa g.init_game_state (History_on_turn g.init_game_state f_strat sSa (t)) =
          sSb g.init_game_state (History_on_turn g.init_game_state f_strat sSb (t)))
...
lemma Conditioning_win [Inhabited β] (g : zGame_World α β) (fst_s: Strategy α β)
  (f_strat : (h : List β) → (hne : h ≠ []) → (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → Strategy α β)
  (h_f_strat : ∀ h H: List β, (hne : h ≠ []) → (Hne : H ≠ []) →
      (hl : g.fst_legal g.init_game_state [] (h.getLast hne)) → (Hl : g.fst_legal g.init_game_state [] (H.getLast Hne)) →
      h.getLast hne = H.getLast Hne →
      f_strat h hne hl = f_strat H Hne Hl)
  (f_act_leg : g.fst_legal g.init_game_state [] (fst_s g.init_game_state []))
  (Leg_f : Strategy_legal_fst g.init_game_state g.fst_legal fst_s (zGame_World.fst_strat_conditioned g f_strat))
  (Leg_s : Strategy_legal_snd g.init_game_state g.snd_legal fst_s (zGame_World.fst_strat_conditioned g f_strat))
  (wlg_ws : ¬Game_World.snd_win_states g.toGame_World g.init_game_state)
  (hw : let f_act := fst_s g.init_game_state []
        Game.fst_win { toGame_World := (g.world_after_fst f_act f_act_leg).toGame_World,
                              ...
                              fst_lawful :=
                                ...
                                dsimp at this
                                rw [zGame_World.world_after_fst_fst_legal, ← this]
                                exact Leg_s),
                              snd_lawful :=
                                (by
                                have := g.conditioned_legal_fst fst_s f_strat h_f_strat f_act_leg
                                dsimp at this
                                rw [zGame_World.world_after_fst_snd_legal, ← this]
                                exact Leg_f),
                                }) :
    Game.snd_win { toGame_World := g.toGame_World,
                          fst_strat := fst_s,
                          snd_strat := (zGame_World.fst_strat_conditioned g f_strat),
                          fst_lawful := (Leg_f),
                          snd_lawful := (Leg_s)} :=
  by
...
def zGame_World.snd_strat_reconditioned (s_strat : Strategy α β) (f_act : β) (g : zGame_World α β) (f_act_leg : g.fst_legal g.init_game_state [] f_act) : Strategy α β :=
  fun _ hist => if hist = [] then f_act else s_strat (g.world_after_fst f_act f_act_leg).init_game_state (hist.dropLast)

def zGame_World.fst_strat_reconditioned (f_strat : Strategy α β) (f_act : β) (g : zGame_World α β) : Strategy α β :=
  fun _ hist => f_strat g.init_game_state (hist ++ [f_act])


lemma zGame_World.history_reconditioned
...
lemma zGame_World.snd_reconditioned_legal
  (g : zGame_World α β) (f_act : β) (f_act_leg : g.fst_legal g.init_game_state [] f_act)
  (snd_s ws : Strategy α β)
  (hf : Strategy_legal_fst g.init_game_state g.fst_legal (snd_strat_reconditioned ws f_act g f_act_leg) snd_s)
  : Strategy_legal_snd (world_after_fst g f_act f_act_leg).toGame_World.init_game_state
  ...
  clear this
  rw [g.sym_legal] at hf
  rw [zGame_World.world_after_fst_snd_legal]
  convert hf using 1
  · dsimp [snd_strat_reconditioned]
...
lemma zGame_World.fst_reconditioned_legal
  (g : zGame_World α β) (f_act : β) (f_act_leg : g.fst_legal g.init_game_state [] f_act)
  (snd_s ws : Strategy α β)
  (hs : Strategy_legal_snd g.init_game_state g.snd_legal (snd_strat_reconditioned ws f_act g f_act_leg) snd_s)
  : Strategy_legal_fst (world_after_fst g f_act f_act_leg).toGame_World.init_game_state
      (world_after_fst g f_act f_act_leg).toGame_World.fst_legal (fst_strat_reconditioned snd_s f_act g) ws
  :=
  by
  intro t ts
  ...
  rw [← this] at hs
  clear this
  rw [zGame_World.world_after_fst_fst_legal]
  convert hs using 1
  apply f_act_leg
...
lemma zGame_World.state_neutral_reconditioned
  (g : zGame_World α β) (f_act : β) (f_act_leg : g.fst_legal g.init_game_state [] f_act)
  (snd_s ws : Strategy α β) :
  ∀ t : ℕ,
...
lemma zGame_World.reCondition_win
  (g : zGame_World α β) (f_act : β) (f_act_leg : g.fst_legal g.init_game_state [] f_act)
  (snd_s ws : Strategy α β)
  ...
  (H : Game.snd_win
    { toGame_World := (g.world_after_fst f_act f_act_leg).toGame_World,
      ...
      fst_lawful :=
          (by
           apply zGame_World.fst_reconditioned_legal
           exact snd_leg)
      snd_lawful :=
        (by
  ...
  : Game.fst_win
  { toGame_World := g.toGame_World, fst_strat := snd_strat_reconditioned ws f_act g f_act_leg, snd_strat := snd_s,
