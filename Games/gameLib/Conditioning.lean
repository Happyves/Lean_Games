...
structure zGame_World (α β : Type _) extends Game_World α β where
  f_legal_careless : careless toGame_World.fst_legal toGame_World.fst_transition
  s_legal_careless : careless toGame_World.snd_legal toGame_World.fst_transition
  f_transition_careless : careless toGame_World.fst_transition toGame_World.fst_transition
  s_transition_careless : careless toGame_World.snd_transition toGame_World.fst_transition
